...
public class AnalisisSemantico {
    ...
    private static final int PARENTESIS_A = 7;
    private static final int PARENTESIS_C = 8;
    private static final int LLAVE_A = 9;
    private static final int LLAVE_C = 10;
    private static final int ELSE = 11;
    private static final int WHILE = 12;
    private static final int SCANF = 13;
    private static final int PRINTF = 14;
    private static final int COMA = 15;
    private static final int CLASE = 16;
    private static final int VOID = 17;
    private static final int OPERADOR_LOGICO = 18;
    private static final int RETORNO = 19;
