 ...
 * @author aloso
 */
public class TablaSemantico extends javax.swing.JFrame {

    /**
     * Creates new form TablaSemantico
     */
    public TablaSemantico() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Tabla de variables");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TablaSemantico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TablaSemantico().setVisible(true);
            }
        });
    }
